        ...
        <CartProvider>
          ...
          <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <a
              ...
              className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 group"
